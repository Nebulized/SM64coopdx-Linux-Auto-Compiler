...
final_command = "git clone https://github.com/coop-deluxe/sm64coopdx.git && cd /home/"+getpass.getuser()+"/sm64coopdx"+" && make"+final_jobs+final_target_bits+final_discord_sdk+final_coopnet+final_headless+final_render_api+final_window_api
